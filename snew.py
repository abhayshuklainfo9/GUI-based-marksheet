...
tk.Label(master, text="MCA 301").grid(row=3, column=1)
tk.Label(master, text="MCA 302").grid(row=4, column=1)
tk.Label(master, text="MCA 303").grid(row=5, column=1)
tk.Label(master, text="MCA 304").grid(row=6, column=1)
